...
define('BOX_SHOPPING_NOW', 'Sie haben ');
define('BOX_SHOPPING_NOW2', ' in Ihrem Einkaufswagen.');
define('BOX_SHOPPING_NOW3', ' in ihrem korb ');
...
define('BOX_MANUFACTURER_INFO_HOMEPAGE', '%s Hausseite');
define('BOX_HOMEPAGE', 'Hauptseite');
...
define('PRICE', 'Unser Preis');
define('PRICE_OLD', 'Alter Preis');
?>
