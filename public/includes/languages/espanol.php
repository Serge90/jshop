...
define('HEADING_SEARCH', 'B&uacute;squeda');
...
define('BOX_SHOPPING_NOW', 'Usted ');
define('BOX_SHOPPING_NOW2', ' ningu- nos articulos en su carrito.');
define('BOX_SHOPPING_NOW3', ' en su cesta ');
...
define('PRICE', 'Nuestro precio');
define('PRICE_OLD', 'Viejo precio');
?>
