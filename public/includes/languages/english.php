...
define('BOX_SHOPPING_NOW', 'You have ');
define('BOX_SHOPPING_NOW2', ' in your shopping cart.');
define('BOX_SHOPPING_NOW3', ' now in your cart');
...
define('IMAGE_BUTTON_IN_CART', 'Add to Shopping Cart');
